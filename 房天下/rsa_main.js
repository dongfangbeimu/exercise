...
location = {
    href: 'http://search.fang.com/captcha-99c8c0c6cdad20826e/?t=1704598893.268&h=aHR0cHM6Ly9lc2YuZmFuZy5jb20vaG91c2Uva3cv&c=cmE6MjIzLjExMi4yMDMuNzE7eHJpOjt4ZmY6',
};
window.history = {
    length: 1,
...
function get_global_cookie() {
    function e(e, o) {
        try {
            var t = e.toString(36);
            return t.length >= o ? t.substring(t.length - o, t.length) : t.substring(0, t.length)
        } catch (e) {
            return "0"
        }
    }

    for (var o = [], t = 0; t < 20; t++) {
        for (var i = Math.round(2147483647 * Math.random()).toString(36); i.length < 6;)
            i = "0" + i;
        o.push(i)
    }
    for (var n = [], r = {}; n.length < 4;) {
        var a = Math.round(2147483647 * Math.random()) % 20;
        void 0 === r[a] && (n.push(o[a]),
            r[a] = !0)
    }
    var s = "";
    s += e(location.href.length, 1),
        s += e(window.history.length, 1),
        s += e(0, 1),
        n.push(s);
    var u = (new Date).getTime().toString(36);
    return u.indexOf("-") >= 0 && (u = u.substring(1, u.length)),
    u.length > 8 && (u = u.substring(u.length - 8, u.length)),
        n.push(u),
        n.join("")
}
...
var a = CryptoJs.RSA.RSAKeyPair("010001", "", "");
